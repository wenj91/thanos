...
func TestShipperTimestamps(t *testing.T) {
	...
	s := New(nil, nil, dir, "fake", nil, nil, metadata.TestSource, false, false, metadata.NoneFunc)
...
func TestIterBlockMetas(t *testing.T) {
	...
	shipper := New(nil, nil, dir, "fake", nil, nil, metadata.TestSource, false, false, metadata.NoneFunc)
...
func TestShipperAddsSegmentFiles(t *testing.T) {
	...
	s := New(nil, nil, dir, "fake", inmemory, func() labels.Labels { return lbls }, metadata.TestSource, false, false, metadata.NoneFunc)
